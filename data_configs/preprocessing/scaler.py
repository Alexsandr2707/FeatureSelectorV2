...
EXECUTE_CONFIG_ROLLING_STANDARD = {
    "random_seed": 0,  # 793
    "dataset": {
        "name": "UZK",
        "features_path": "data/uzk.csv",
    ...
    "preprocess": {
        ...
        "steps_configs": {
            ...
            "scaler": {
                "enabled": True,
                "X": {"enabled": True, "dtype": "standard_rolling", "window": 48},
                "y": {"enabled": True, "dtype": "standard"},
            },
            "feature_selector": {
                "enabled": True,
...
EXECUTE_CONFIG_ROLLING_ROBUST = {
    ...
    "preprocess": {
        ...
        "steps_configs": {
            ...
            "scaler": {
                "enabled": True,
                "X": {"enabled": True, "dtype": "robust_rolling", "window": 48},
                "y": {"enabled": True, "dtype": "standard"},
            },
            "feature_selector": {
                "enabled": True,
